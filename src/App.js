...
function App(props) {
  ...
  const [queryStringText, setQueryStringText] = useState(
  ...
  const fetchQuerytStringText = () => {
    if (window.location.search) {
      axios
        .get(`${process.env.REACT_APP_API_URL}${window.location.search}`)
        .then((res) => {
          ...
          <Switch>
            ...
            <Route path="/">
              ...
              <div className="headerino">
                <div className="logospace"> Streaming Service Logo
                  {/* <svg
                ...
                <div className="iconsMenu">
                  ...
                  >
                    ...
                    >
                      <path
                        d="M9.43317 14.6975C9.10706 14.6975 8.84269 14.4331 8.84269 14.107V8.32958C8.84269 8.00347 9.10706 7.7391 9.43317 7.7391C9.75929 7.7391 10.0237 8.00347 10.0237 8.32958V14.107C10.0237 14.4331 9.75929 14.6975 9.43317 14.6975ZM10.2 5.57103C10.2 5.99219 9.85853 6.33365 9.43737 6.33365C9.00975 6.33365 8.66635 5.99412 8.66635 5.57103C8.66635 5.14147 9.00781 4.8 9.43737 4.8C9.86046 4.8 10.2 5.1434 10.2 5.57103Z"
                        fill="white"
                        stroke="white"
                        stroke-width="0.5"
                      />
                      <path
                        d="M9.5 0C4.26444 0 0 4.26444 0 9.5C0 14.7356 4.26444 19 9.5 19C14.7356 19 19 14.7356 19 9.5C19 4.26444 14.7356 0 9.5 0ZM9.5 17.7333C4.95689 17.7333 1.26667 14.0431 1.26667 9.5C1.26667 4.95689 4.95689 1.26667 9.5 1.26667C14.0431 1.26667 17.7333 4.95689 17.7333 9.5C17.7333 14.0431 14.0431 17.7333 9.5 17.7333Z"
                        fill="white"
                      />
                    </svg>
                  </div>
