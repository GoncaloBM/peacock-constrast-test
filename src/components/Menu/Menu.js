...
const Menu = (props) => {
    ...
    return ( <
        ...
        <
        Twitterpicker previewColor = { props.colorText }
        isText = { true }
        getColor = {
            (color, isText) => props.getColor(color, isText) }
        ...
        <
        Alphapicker previewColor = { props.colorText }
        isText = { true }
        getColor = {
            (color, isText) => props.getColor(color, isText) }
